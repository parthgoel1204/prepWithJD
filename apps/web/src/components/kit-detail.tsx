...
export default function KitDetail() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-8">
      ...
      {tab === "requirements" && (
        <section className="mt-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="text-base font-semibold text-slate-800">Requirements — {reqs.length} extracted</h2>
          {generated ? (
      ...
      {tab === "flashcards" && (
        <section className="mt-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="text-base font-semibold text-slate-800">Flashcards — {flashes.length} cards</h2>
          {generated ? (
            <>
      ...
      {tab === "practice" && (
        <section className="mt-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <h2 className="text-base font-semibold text-slate-800">Practice</h2>
            <button
      ...
      {tab === "schedule" && (
        <section className="mt-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="text-base font-semibold text-slate-800">Schedule — {scheduleDays} days planned</h2>
          {generated ? (
            <>
              {noScheduleMaterial && (
